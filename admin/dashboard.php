...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="dist/img/mylogo.png" alt="DevLogo" height="150" width="150">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="dist/img/cadetlogo_prev_ui.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">3BH-Portal</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="dist/img//profileh.png" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">Abraham Adejumo</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="settings.php" class="nav-link">
                                <!-- The Icon Tag -->
                                <i class="nav-icon fa-solid fa-gear h-6 w-6 mr-3"></i>
                                <p>Settings</p>
                            </a>
                        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    <h3 id="user-registrations-count">...</h3>
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-danger">
                                <div class="inner">
                                    <h3 id="unique-visitors-count">...</h3>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2025-2026 <a href="https://index.html">3rd Brigade Hqs</a>.</strong>
            All rights reserved.
    ...
    <!-- ./wrapper -->
    <script>
        // Add this script to your main dashboard HTML file (e.g., index.html)
        ...
        const signIn = async () => {
            try {
                ...
                // Once signed in, start listening to data
                listenToData();
            } catch (error) {
        ...
        function listenToData() {
            // --- Get references to the h3 tags in your stat boxes ---
            const newApplicationsEl = document.getElementById('new-applications-count');
            const bounceRateEl = document.getElementById('bounce-rate-count');
            const userRegistrationsEl = document.getElementById('user-registrations-count');
            const uniqueVisitorsEl = document.getElementById('unique-visitors-count');

            // 1. Listen to New Applications
            const applicationsRef = collection(db, `artifacts/${appId}/public/data/applications`);
            onSnapshot(applicationsRef, (snapshot) => {
                newApplicationsEl.textContent = snapshot.size;
            });

            // 2. Listen to User Registrations
            const usersRef = collection(db, `artifacts/${appId}/public/data/users`);
            onSnapshot(usersRef, (snapshot) => {
                userRegistrationsEl.textContent = snapshot.size;
            });

            // 3. Listen to Bounce Rate
            const bounceRateRef = doc(db, `artifacts/${appId}/public/data/analytics/bounceRate`);
            onSnapshot(bounceRateRef, (docSnap) => {
                if (docSnap.exists()) {
                    bounceRateEl.innerHTML = `${docSnap.data().currentRate}<sup style="font-size: 20px">%</sup>`;
                }
            });

            // 4. Listen to Unique Visitors
            const visitorsRef = doc(db, `artifacts/${appId}/public/data/analytics/visitors`);
            onSnapshot(visitorsRef, (docSnap) => {
                if (docSnap.exists()) {
                    uniqueVisitorsEl.textContent = docSnap.data().todayCount;
                }
            });
        }
    </script>
